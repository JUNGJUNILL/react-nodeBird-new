...
function uploadImagesAPI(data) {
  console.log('upload saga ==> ',data); 
                                    //formData로 넘겼으면 생으로 data라고 입력 해 줘야 한다.
...
function* loadPosts(action) {
  try {
    console.log('lastId===>', action.data); 
    const result = yield call(loadPostsAPI,action.data.lastId);
    yield put({
...
function addPostAPI(data) {
  ...
  console.log('게시물 등록=>>',data); 
  return axios.post('/post', data );
                            //formData 라서 생으로 data 입력함 
}
